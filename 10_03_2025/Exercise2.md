...
#euro12.dtypes.value_counts() #copied from the guide
#but it returns the types of the data, so you need to add them together
```
...
```python
euro12[euro12['Team'].str[0] == 'G'] #.str to enable string operations on members of columns
```
