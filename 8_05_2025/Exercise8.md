...
```python
stats.tmean(df_gapminder['gdp_cap'])
```
...
#### Calculate the mean life expectancy for Poland in 2007
...
#### Calculate the mean life expectancy for European countries in 2007


```python
df_europe = df_gapminder[(df_gapminder['continent'] == 'Europe') & (df_gapminder['year'] == 2007)]
df_europe['life_exp'].mean()
```
...
```
    ...
    <matplotlib.lines.Line2D at 0x13fdb83e0>




    
![png](Exercise8_files/Exercise8_36_1.png)
...
av_num = np.array([2.5, 2.5, 2.5, 2.5]) - numbers
sum(av_num)
```
...
![png](Exercise8_files/Exercise8_45_0.png)
...
![png](Exercise8_files/Exercise8_61_0.png)
